...
public class DragonSkeleton extends StructureFeature<DefaultFeatureConfig>{

	public DragonSkeleton(Codec<DefaultFeatureConfig> codec) {
		super(codec);
	}
	...
	public static class Start extends StructureStart<DefaultFeatureConfig> {
		...
		public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator,
			...
			DragonSkeletonGenerator.addPieces(manager, pos, rotation, this.children);
