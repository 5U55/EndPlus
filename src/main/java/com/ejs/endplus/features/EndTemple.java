...
public class EndTemple extends StructureFeature<DefaultFeatureConfig>{

	public EndTemple(Codec<DefaultFeatureConfig> codec) {
		super(codec);
	}
	...
	public static class Start extends StructureStart<DefaultFeatureConfig> {
		...
		public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator,
			...
			EndTempleGenerator.addPieces(manager, pos, rotation, this.children);
